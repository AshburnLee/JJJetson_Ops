...
~~~sh
mkdir ./obj
nvcc  softmax-target.cu -o softmax
nvcc -I/home/junhui/workspace/my-ops/include softmax-target.cu -o ./obj/softmax
nvcc -arch=sm_87 -I/home/junhui/workspace/my-ops/include softmax-target.cu -o ./obj/softmax
~~~

~~~sh
mkdir ./ncu
sudo $(which ncu) -o ./ncu/softmax-last.ncu-rep ./obj/softmax
sudo $(which ncu) --kernel-name ComputeLogSoftmaxForwardInWarp --output-file softmax-last.ncu-rep ./obj/softmax
sudo $(which ncu) --set quick --output-file softmax-last.ncu-rep ./obj/softmax
sudo $(which ncu) --set full --output-file softmax-last.ncu-rep ./obj/softmax
sudo $(which ncu) --set quick --kernel-name ComputeLogSoftmaxForwardInWarp --output-file softmax-last.ncu-rep ./obj/softmax

# 在终端输出报告的文本摘要
sudo $(which ncu) --import ./ncu/softmax-last.ncu-rep > ./ncu/softmax-last.txt
~~~
...
sudo $(which ncu) --mode=launch-and-attach --kernel-name ComputeLogSoftmaxForwardInWarp --metric sm__clock_frequency_max ./obj/softmax
~~~
