...
void fa_one_pass_parallel_tc_true_py(py::buffer q, py::buffer k, py::buffer v,
                                     py::array_t<float> dst, float scale) {
...
void fa_one_pass_parallel_double_buffer_py(py::buffer q, py::buffer k, py::buffer v,
                                           py::array_t<float> dst, float scale) {
...
PYBIND11_MODULE(fa_tc_me, m) {
    ...
    m.def("launch_fa_one_pass_parallel_double_buffer", &fa_one_pass_parallel_double_buffer_py,
