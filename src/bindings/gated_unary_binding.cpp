...
PYBIND11_MODULE(gated_unary_me, m) {
    ...
    m.def(
        "relu_gated",
        [](py::buffer src0, py::buffer src1, py::buffer dst, const std::vector<int> dst_dims,
           const std::vector<int> src0_nb, const std::vector<int> src1_nb) {
            ...
            relu_gated(static_cast<const float *>(src0_buff.ptr),
                       ...
                       static_cast<float *>(dst_buff.ptr), dst_dims, src0_nb, src1_nb);
        },
        py::arg("src0"), py::arg("src1"), py::arg("dst"), py::arg("dst_dims"), py::arg("src0_nb"),
        py::arg("src1_nb"));
    m.def(
        "gelu_gated",
        [](py::buffer src0, py::buffer src1, py::buffer dst, const std::vector<int> dst_dims,
