    ...
    m.def(
        ...
        [](py::array_t<float, py::array::c_style | py::array::forcecast> x,
           ...
           int top_k) {
            ...
            moe_pipeline_forward(static_cast<float *>(bx.ptr), static_cast<int *>(bid.ptr),
                                 static_cast<float *>(brw.ptr), static_cast<float *>(bwg.ptr),
                                 static_cast<float *>(bwu.ptr), static_cast<float *>(bwd.ptr),
                                 static_cast<float *>(by.ptr), num_tokens, hidden_size,
                                 intermediate_size, num_experts, top_k, nullptr);
        },
        py::arg("x"), py::arg("expert_ids"), py::arg("route_weights"), py::arg("w_gate"),
        py::arg("w_up"), py::arg("w_down"), py::arg("y"), py::arg("intermediate_size"),
        py::arg("num_experts"), py::arg("top_k"));
}
